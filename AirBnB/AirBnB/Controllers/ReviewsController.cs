...
namespace AirBnB.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Reviews.Include(r => r.AppUser).Include(r => r.Property);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,AppUserId,PropertyId,ReviewRate,ReviewComment")] Review review)
        {
